...
try:
    from agent.utils import setup_web3, load_abi
...
def create_oracle_task(oracle, task_data="Prediction market question: Will ETH reach $5000 by the end of 2025? Please respond with YES or NO."):
    """
